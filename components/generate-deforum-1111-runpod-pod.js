...
async function generateDeforum1111RunpodPod(imageRequest) {
    ...
    const parameters = {
        deforum_settings: {
            ...
            "sd_model_hash": "be9edd61",
            "deforum_git_commit_id": "d8764419"
        }
    }
    ...
    try {
        ...
        // Assuming that if jsonResponse contains some indication of success, return success message
